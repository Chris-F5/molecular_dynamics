...
mols = []
mols.append(create_water_molecule([2.1, 1.0, 1.0], np.array([1.0,0.0,0.0]), np.array([0,1,0])))
mols.append(create_water_molecule([2.25, 1.0, 1.0], np.array([1.0,0.5,0.0]), np.array([0,1,0])))
